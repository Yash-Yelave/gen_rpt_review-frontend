...
// .wrangler/tmp/pages-Fymrcw/functionsWorker-0.7776846584925489.mjs
...
var S3Bucket = class {
  static {
    __name(this, "S3Bucket");
  }
  static {
    __name2(this, "S3Bucket");
  }
  aws;
  baseUrl;
  constructor(env) {
  ...
  async get(key) {
    ...
    return {
      body: res.body,
      json: /* @__PURE__ */ __name2(() => res.json(), "json"),
      text: /* @__PURE__ */ __name2(() => res.text(), "text")
    };
  }
...
__name2(getCatalog, "getCatalog");
async function updateCatalogEntry(bucket, id, updates) {
...
__name(updateCatalogEntry, "updateCatalogEntry");
__name2(updateCatalogEntry, "updateCatalogEntry");
async function getManifest(bucket, id) {
  try {
...
async function putManifest(bucket, id, manifest) {
  await bucket.put(`reports/${id}/manifest.json`, JSON.stringify(manifest), {
    httpMetadata: { contentType: "application/json" }
  });
}
__name(putManifest, "putManifest");
__name2(putManifest, "putManifest");
async function getComments(bucket, id) {
  try {
...
async function putComments(bucket, id, comments) {
  await bucket.put(`reports/${id}/comments.json`, JSON.stringify(comments), {
    httpMetadata: { contentType: "application/json" }
  });
}
__name(putComments, "putComments");
__name2(putComments, "putComments");
...
function parseMarkdownToSectionsWithRaw(md) {
...
__name(parseMarkdownToSectionsWithRaw, "parseMarkdownToSectionsWithRaw");
__name2(parseMarkdownToSectionsWithRaw, "parseMarkdownToSectionsWithRaw");
function headingSlug(heading) {
  return heading.toLowerCase().replace(/[^\w]+/g, "-").replace(/^-|-$/g, "");
}
__name(headingSlug, "headingSlug");
__name2(headingSlug, "headingSlug");
...
__name(sectionsToMarkdown, "sectionsToMarkdown");
__name2(sectionsToMarkdown, "sectionsToMarkdown");
var onRequestPut = /* @__PURE__ */ __name2(async (context) => {
  ...
  try {
    ...
    const reportMdKey = manifest?.files?.report_md;
    if (!reportMdKey) {
      return jsonError(
    ...
    for (const [paraId, newText] of Object.entries(body.edits)) {
      ...
      for (const section of sections) {
        ...
        const rawParas = section.body.split("\n\n").map((p) => p.trim()).filter((p) => p.length > 0);
        let paraCounter = 0;
...
var onRequestPost2 = /* @__PURE__ */ __name2(async (context) => {
  ...
  if (status === void 0 && humanStatus === void 0 && publishReady === void 0) {
  ...
  try {
    ...
    if (humanStatus !== void 0) patch["humanStatus"] = humanStatus;
    if (publishReady !== void 0) patch["publishReady"] = publishReady;
    const updatedManifest = { ...manifest, ...patch };
    await putManifest(bucket, id, updatedManifest);
    await updateCatalogEntry(bucket, id, {
      ...status !== void 0 && { status },
      ...humanStatus !== void 0 && { humanStatus },
      ...publishReady !== void 0 && { publishReady },
...
__name(parseMarkdownToSections, "parseMarkdownToSections");
__name2(parseMarkdownToSections, "parseMarkdownToSections");
var onRequestGet4 = /* @__PURE__ */ __name2(async (context) => {
  ...
  try {
    ...
    const mapStatus = /* @__PURE__ */ __name2((s) => {
      const map = {
        "generated": "Generated",
    ...
    const extractStrings = /* @__PURE__ */ __name2((arr) => {
    ...
    const aiReviewObj = reviewJsonData ? {
      ...
      recommendations: {
        ...
        priority_improvements: (recs.priority_improvements || recs.improvement_tasks || reviewJsonData?.priority_improvements || []).map((imp) => ({
    ...
    const report = {
      ...
      commentCount: comments.length,
      lastUpdated: manifest.updated_at || (/* @__PURE__ */ new Date()).toISOString(),
      publishReady: false,
...
var onRequestGet5 = /* @__PURE__ */ __name2(async (context) => {
  try {
    ...
    const mappedCatalog = catalogData.map((item) => ({
      ...
      aiGrade: "N/A",
      // Assuming grade is no longer provided
      commentCount: 0,
      // Set to 0 in catalog list, filled in on specific report load
...
// C:/Users/yashy/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// C:/Users/yashy/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// .wrangler/tmp/bundle-ZSNgrV/middleware-insertion-facade.js
...
// C:/Users/yashy/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/middleware/common.ts
...
// .wrangler/tmp/bundle-ZSNgrV/middleware-loader.entry.ts
...
aws4fetch/dist/aws4fetch.esm.mjs:
   ...
   *)
*/
//# sourceMappingURL=functionsWorker-0.7776846584925489.js.map
