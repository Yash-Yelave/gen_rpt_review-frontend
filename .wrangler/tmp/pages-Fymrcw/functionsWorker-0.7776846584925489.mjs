...
var S3Bucket = class {
  ...
  async get(key) {
    ...
    return {
      body: res.body,
      json: /* @__PURE__ */ __name(() => res.json(), "json"),
      text: /* @__PURE__ */ __name(() => res.text(), "text")
    };
  }
...
var onRequestGet4 = /* @__PURE__ */ __name(async (context) => {
  ...
  try {
    ...
    const mapStatus = /* @__PURE__ */ __name((s) => {
      const map = {
        "generated": "Generated",
    ...
    const extractStrings = /* @__PURE__ */ __name((arr) => {
...
// ../.wrangler/tmp/pages-Fymrcw/functionsRoutes-0.6846603454383664.mjs
var routes = [
  {
...
// C:/Users/yashy/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// C:/Users/yashy/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
...
// ../.wrangler/tmp/bundle-NxMU5l/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-NxMU5l/middleware-loader.entry.ts
...
aws4fetch/dist/aws4fetch.esm.mjs:
   ...
   *)
*/
//# sourceMappingURL=functionsWorker-0.7776846584925489.mjs.map
